...
public class CidadesController {
	...
	@Cacheable(value = "cidades", key = "#codigoEstado")//o 'key' serve para o cacheEvict 'key' para acessar esse valor
	...
	@PostMapping("/nova")
	@CacheEvict(value = "cidades", key = "#cidade.estado.codigo", condition = "#cidade.temEstado()")//condition foi implementado na classe Cidade.java
